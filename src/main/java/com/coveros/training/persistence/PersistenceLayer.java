...
public class PersistenceLayer {
     ...
     */
    long INSERT_TEMPLATE(SqlData sqlData) {
    ...
    long saveNewBorrower(String borrowerName) {
        String description = "adds a new library borrower";
        String preparedStatement = "INSERT INTO library.borrower (name) VALUES (?);";

        final SqlData sqlData = new SqlData(description, preparedStatement);
        sqlData.addParameter(borrowerName, String.class);

        return INSERT_TEMPLATE(sqlData);
    }
    ...
    long createLoan(Book book, Borrower borrower, Date borrowDate) {
        String description = "Creates a new loan of a book to a borrower";
        String preparedStatement = "INSERT INTO library.loan (book, borrower, borrow_date) VALUES (?, ?, ?);";
    ...
    long saveNewBook(String bookTitle) {
        String description = "Creates a new book in the database";
        String preparedStatement = "INSERT INTO library.book (title) VALUES (?);";
    ...
    long saveNewUser(String username) {
        String description = "Creates a new user in the database";
        String preparedStatement = "INSERT INTO auth.user (name) VALUES (?);";
